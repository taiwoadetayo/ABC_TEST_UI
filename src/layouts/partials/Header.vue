          ...
          <b-dropdown size="sm" variant="dual" class="d-inline-block ml-2" menu-class="p-0 border-0 dropdown-menu-md" right no-caret ref="oneDropdownDefaultUser">
            <template #button-content>
              <div class="d-flex align-items-center">
                ...
                <span class="d-none d-sm-inline-block ml-2">{{user_data.group_name}}</span>
            ...
            <li @click="$refs.oneDropdownDefaultUser.hide(true)">
              <div class="p-3 text-center bg-primary-dark rounded-top">
                ...
                <p class="mt-2 mb-0 text-white font-w500">{{user_data.fullname}}</p>
                <p class="mb-0 text-white-50 font-size-sm" style="word-break: break-all;font-size: 10px !important;">{{user_data.username}}</p>
              </div>
              <div class="p-2">
                ...
                <router-link class="dropdown-item d-flex bg-success align-items-center justify-content-between" to="/?logout=true">
