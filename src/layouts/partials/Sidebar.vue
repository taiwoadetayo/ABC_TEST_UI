    ...
    <slot>
      ...
      <div class="content-header bg-white-5">
        ...
        <router-link to="/" class="font-w600 text-dual">
          ...
          <span class="smini-hide font-size-h1 tracking-wider">
            <img src="/img/photos/fmn-logo.png" width="90px" height="60px">
          </span>
        </router-link>
        <!-- END Logo -->
      ...
      <simplebar class="js-sidebar-scroll">
        ...
        <div class="content-side">
              <!-- <div class="p-3 text-center rounded-top">
                ...
                <p class="mb-0 text-white-50 font-size-sm" style="word-break: break-all;font-size: 12px !important;">{{user_data.role}}</p>
              </div> -->
